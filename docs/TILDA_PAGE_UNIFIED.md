...
| `chosen_stage` | **все тарифы** — период `1` (6 июля) или `2` (27 июля) |
...
3. Дата старта          → chosen_stage (6 июля = 1, 27 июля = 2)
...
<div id="single-options" style="display:none">
  <select name="chosen_stage" id="chosen_stage">
    ...
    <option value="1">Старт курса 6 июля (4 сказки)</option>
    <option value="2">Старт 27 июля (4 сказки)</option>
  </select>
