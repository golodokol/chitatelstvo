...
var CHIT_SCHEDULE = {
  '1': {
    lessons: ['15 июля', '3 августа', '14 сентября', '21 сентября'],
  ...
  '2': {
    lessons: ['28 сентября', '5 октября', '12 октября', '19 октября'],
...
var CHIT_LESSON_OPENS_ISO = {
  '1': ['2026-07-15', '2026-08-03', '2026-09-14', '2026-09-21'],
  '2': ['2026-09-28', '2026-10-05', '2026-10-12', '2026-10-19']
};
