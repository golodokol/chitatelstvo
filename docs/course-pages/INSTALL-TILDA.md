...
**Версия лендингов:** `20260710c` · цены от **990 ₽**

Как вынести лендинги из `docs/course-pages/` на прод и связать с **Zero Block** главной и страницей **`chitatelstvo.ru/oplata`**.

## Быстрый старт (только Tilda)

1. Файлы лендингов уже на API — шаг 1 ниже выполнен на сервере.
2. Создайте **7 страниц-редиректов** — см. `tilda-redirects/README.md`.
3. Проверьте оплату `/oplata` — шаг 2 ниже.
4. Пройдите тест: главная → `1-klass` → Записаться → оплата.
...
|----------|------|------------|
| Читательство · Разовое | 990 ₽ | `797131986522` |
