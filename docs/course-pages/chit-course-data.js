...
window.CHIT_COURSE = (function () {
  ...
  var RONI_LESSON_OPEN_ISO = '2026-09-07';
  ...
  var META = {
    'grade-1': {
      ...
      badge: 'Базовый курс',
      age: '7–8 лет',
      h1: 'Курсы по литературе · 1 класс',
      lead: 'Курсы по литературе для 1 класса: 8 сказок из школьных списков — видео, задания на понимание и личная страница прогресса.',
      intro: 'Онлайн-курс литературы для 1 класса: сказки из школьных списков — разбираем героя, сюжет и смысл каждой истории.',
      forWhom: [
      ...
      outcomeTitle: 'После курса',
      outcomeLead: 'К концу программы ребёнок не «закрыл список», а научился читать сказки с пониманием.',
      outcome: [
        'Прошёл 8 сказок из школьных списков 1 класса',
        'Умеет сказать, о чём история, и кто герой',
        'Видит свой прогресс на личной странице — баллы и открытые уроки',
        'Привыкает читать с интересом, а не только «для школы»'
      ]
    },
    'grade-2': {
      file: 'grade-2.html',
      badge: 'Базовый курс',
      age: '8–9 лет',
      h1: 'Курсы по литературе · 2 класс',
      lead: 'Курсы по литературе для 2 класса: 8 сказок и повестей — от Пушкина до Андерсена. Видеоуроки, вопросы на смысл и прогресс на личной странице.',
      intro: 'Онлайн-курс литературы для 2 класса — с акцентом на понимание героя и сюжета.',
      forWhom: [
      ...
      outcomeTitle: 'После курса',
      outcomeLead: 'После двух блоков ребёнок увереннее держит сюжет и мотивы героев.',
      outcome: [
        'Разобрал 8 произведений программы 2 класса',
        'Понимает поступки героев и может объяснить их своими словами',
        'Умеет отвечать на вопросы к тексту, а не только пересказывать',
        'Видит накопленный прогресс и готовность к следующим книгам'
      ]
    },
    'grade-3': {
      file: 'grade-3.html',
      badge: 'Базовый курс',
      age: '9–10 лет',
      h1: 'Курсы по литературе · 3 класс',
      lead: 'Курсы по литературе для 3 класса: 8 произведений — от пушкинских сказок до «Королевства кривых зеркал». Герои, замысел, эмоции.',
      intro: 'Онлайн-курс литературы для 3 класса: тексты из школьной программы чтения с разбором смысла.',
      forWhom: [
      ...
      outcomeTitle: 'После курса',
      outcomeLead: 'Финал курса — умение читать глубже: замысел, эмоции, связь с собой.',
      outcome: [
        'Прошёл 8 произведений из программы 3 класса',
        'Замечает замысел автора и настроение текста',
        'Умеет говорить о героях и их переживаниях',
        'Читает осознаннее и видит свой рост на личной странице'
      ]
    },
    'grade-4': {
      file: 'grade-4.html',
      badge: 'Базовый курс',
      age: '10–11 лет',
      h1: 'Курсы по литературе · 4 класс',
      lead: 'Курсы по литературе для 4 класса: 8 книг — от бажовских сказов до «Пеппи» и Гулливера. Видео, задания и прогресс на платформе.',
      intro: 'Онлайн-курс литературы для 4 класса: произведения из школьных списков — с разбором смысла и героев.',
      forWhom: [
      ...
      outcomeTitle: 'После курса',
      outcomeLead: 'После курса ребёнок уверенно работает с более объёмными текстами.',
      outcome: [
        'Прочитал и разобрал 8 книг программы 4 класса',
        'Удерживает длинный сюжет и характеры героев',
        'Умеет формулировать главную мысль и своё отношение к книге',
        'Готов к чтению средней школы с опорой на смысл, а не на «галочку»'
      ]
    },
    'extra-6-8': {
      file: 'extra-6-8.html',
      ...
      outcomeTitle: 'После курса',
      outcomeLead: 'К концу курса у ребёнка появляется «своя полка» любимых внеклассных книг.',
      outcome: [
        'Познакомился с 8 тёплыми и приключенческими книгами',
        'Читает вне учебника с интересом и без давления',
        'Умеет коротко рассказать, о чём книга и кто герой',
        'Хочет следующую историю — чтение становится привычкой'
      ]
    },
    'extra-9-11': {
      ...
      outcomeTitle: 'После курса',
      outcomeLead: 'После программы ребёнок читает охотнее и глубже — с системой, а не вразброс.',
      outcome: [
        'Прошёл 8 повестей для думающих читателей 9–11 лет',
        'Умеет обсуждать книгу: сюжет, герои, свои впечатления',
        'Расширил круг чтения за пределы школьного списка',
        'Видит прогресс и готовность к более сложным текстам'
      ]
    }
  };
  ...
  var REVIEWS = [
    {
      text: 'Было интересно проходить урок, сыну понравилось собирать словики и проходить «путь героя»! Ждёт открытия новых курсов!',
      author: 'Мария, мама'
    },
    {
