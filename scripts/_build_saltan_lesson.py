    ...
    "meaning_quiz": {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": [
                    opt("truth", "Он добивается правды, но не мстит убийством"),
                    opt(
                        "build",
        ...
        "questions": [
            {
                "id": "r1",
                "type": "ordering",
                "text": "Расставь смысловые узлы сказки по порядку.",
                "items": [
                    {
                        "id": "e1",
                        "text": "Клевета и подмена письма",
                        "image": f"{IMG}/event-01.png",
                        "alt": "Клевета и подмена письма",
                    },
                    {
                        "id": "e2",
                    ...
                    {
                        "id": "e3",
                        "text": "Остров, спасение Лебеди, княжество Гвидона",
                        "image": f"{IMG}/event-03.png",
                        "alt": "Остров и Лебедь",
                    },
                    {
                        "id": "e4",
                        "text": "Три визита Гвидона к отцу",
                        "image": f"{IMG}/event-04.png",
                        "alt": "Визиты к Салтану",
                    },
                    {
                        "id": "e5",
                        "text": "Салтан приплывает — правда открывается, семья вместе",
