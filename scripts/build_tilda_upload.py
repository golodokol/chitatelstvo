...
def main() -> None:
    ...
    content = f"""<!-- Читательство · единый файл для HTML-элемента Zero Block ({VERSION})
     ...
     Изменения: даты старта 6 и 27 июля в шаге записи; поле «Как присылать новости» скрыто (email);
     промокод в форме; кнопка «Оплатить» с пересчётом суммы при промокоде (если включены промокоды в ST100).
-->
