    ...
    "meaning_quiz": {
        ...
        "questions": [
            ...
            },
            {
                "id": "m4",
                "type": "multi",
                "text": "Какие пословицы о доме подходят к книге?",
                "hint": (
                    "В книге дом — это не стены, а близкие рядом. "
                    "Отметь все пословицы, где дом или место ценятся людьми, теплом и согласием — это метафора."
                ),
                "options": [
        ...
        "questions": [
            {
                "id": "r1",
                "type": "ordering",
                "text": "Расставь смысловые узлы книги по порядку.",
                "items": [
                    {
                        "id": "e1",
                        "text": "Наводнение уносит дом муми-троллей",
                        "image": f"{IMG}/event-01.png",
                        "alt": "Наводнение",
                    },
                    {
                        "id": "e2",
                        "text": "Герои попадают в плавучий театр",
                        "image": f"{IMG}/event-02.png",
                        "alt": "Театр",
                    },
                    {
                        "id": "e3",
                        "text": "Каждый ищет свою роль и опору",
                        "image": f"{IMG}/event-03.png",
                        "alt": "Роли",
                    },
                    {
                        "id": "e4",
                        "text": "Испытания сближают и открывают характеры",
                        "image": f"{IMG}/event-04.png",
                        "alt": "Испытания",
                    },
                    {
                        "id": "e5",
                        "text": "Вывод: дом — это семья и найденный путь",
