        ...
        "questions": [
            {
                ...
                "hint": (
                    "Перетащи описания событий в ячейки 1–6 по порядку книги. "
                ...
                "items": [
                    {"id": "e1", "text": "Наводнение накрывает Муми-долину."},
                    {"id": "e2", "text": "Герои попадают в плавучий театр."},
                    {
                        "id": "e3",
                        "text": "Там герои обретают новых друзей и учатся жить в необычном месте.",
                    },
                    {
                        "id": "e4",
                        "text": "Муми-тролли решают поставить новый спектакль и вместе готовят представление.",
                    },
                    {
                        "id": "e5",
                        "text": "Во время всех испытаний они поддерживают друг друга и не теряют доброты.",
                    },
                    {
                        "id": "e6",
                        "text": (
                            "Даже в трудные времена семья, дружба и взаимопомощь помогают "
                            "справиться со всем — семья возвращается в муми-дом."
                        ),
                    },
                ],
