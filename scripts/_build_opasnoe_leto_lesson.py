        ...
        "questions": [
            {
                ...
                "items": [
                    {
                        "id": "e1",
                        "text": "Наводнение заливает Муми-долину, семья спасается из дома.",
                    },
                    {
                        "id": "e2",
                        "text": "Герои находят плавучий театр и поселяются в нём.",
                    },
                    {
                        "id": "e3",
                        "text": "Эмма объясняет, что это театр, а не обычный дом.",
                    },
                    {
                        "id": "e4",
                        "text": "Театр уплывает, и часть друзей оказывается разлучена.",
                    },
                    {
                        "id": "e5",
                        "text": "Семья готовит спектакль, и на сцене все снова встречаются.",
                    },
                    {
                        "id": "e6",
                        "text": "Вода спадает, герои возвращаются в муми-дом.",
                    },
                ],
