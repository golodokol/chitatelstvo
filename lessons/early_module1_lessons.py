...
def _letters_1() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "grid_cols": 5,
            "moving": False,
            "correct_ids": ["m1", "m2", "m3", "m4", "m5", "m6"],
            "hotspots": [
                {"id": "a1", "label": "А", "size": "sm"},
                {"id": "m1", "label": "М", "size": "sm"},
                {"id": "o1", "label": "О", "size": "sm"},
                {"id": "u1", "label": "У", "size": "sm"},
                {"id": "s1", "label": "С", "size": "sm"},
                {"id": "m2", "label": "М", "size": "sm"},
                {"id": "k1", "label": "К", "size": "sm"},
                {"id": "n1", "label": "Н", "size": "sm"},
                {"id": "m3", "label": "М", "size": "sm"},
                {"id": "a2", "label": "А", "size": "sm"},
                {"id": "o2", "label": "О", "size": "sm"},
                {"id": "m4", "label": "М", "size": "sm"},
                {"id": "u2", "label": "У", "size": "sm"},
                {"id": "s2", "label": "С", "size": "sm"},
                {"id": "a3", "label": "А", "size": "sm"},
                {"id": "m5", "label": "М", "size": "sm"},
                {"id": "o3", "label": "О", "size": "sm"},
                {"id": "k2", "label": "К", "size": "sm"},
                {"id": "u3", "label": "У", "size": "sm"},
                {"id": "m6", "label": "М", "size": "sm"},
                {"id": "s3", "label": "С", "size": "sm"},
                {"id": "a4", "label": "А", "size": "sm"},
                {"id": "n2", "label": "Н", "size": "sm"},
                {"id": "o4", "label": "О", "size": "sm"},
                {"id": "u4", "label": "У", "size": "sm"},
            ],
            "spark": False,
            "spark_group": "letter",
        },
