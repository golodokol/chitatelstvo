...
STAGE_1_START = date(2026, 7, 22)
STAGE_2_START = date(2026, 10, 5)
# Старт до переноса (+1 неделя); для сохранения доступа ранним ученикам.
LEGACY_MODULE_START = date(2026, 7, 6)

# 1–4 класс и внеклассное чтение: по одной сказке в неделю (6 программ).
# 1–2 открыты (сдвиг +1 нед.); 3 — 24 сен (было 14); 4 — 28 сен;
# 5 — 5 окт; 6 — 12 окт; 7 — 19 окт; 8 — 26 окт.
# Рони (extra-9-11, сказка 2) — 7 сен (было 31 авг).
...
RONI_LESSON_OPEN = date(2026, 9, 7)
