...
STAGE_2_LESSON_OPENS = (
    date(2026, 8, 15),  # было 10 августа → перенос на 15
    date(2026, 8, 17),
    date(2026, 8, 24),
    date(2026, 8, 31),
)
